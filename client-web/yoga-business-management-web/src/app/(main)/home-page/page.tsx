...
const HomePage: React.FC<IHomePageProps> = (props) => {
    ...
    return (
        <>
            {/* Thêm ảnh ở đầu trang */}
            <Box sx={{ position: "relative", height: "300px", width: "100%", mb: 2 }}> {/* Tùy chỉnh chiều cao và chiều rộng theo ý muốn */}
                <Image
                    src="https://bizweb.dktcdn.net/100/262/937/themes/813962/assets/slider_3.jpg?1720673795720" // Thay đổi đường dẫn đến ảnh của bạn
                    alt="Description of the image"
                    layout="fill" // Hoặc sử dụng layout="responsive" nếu cần
                    objectFit="cover" // Để ảnh được căn vừa
                />
            </Box>
