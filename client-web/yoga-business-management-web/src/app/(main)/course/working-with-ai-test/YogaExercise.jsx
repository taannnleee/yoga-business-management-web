...
import useYogaDetector, { ID_TO_CLASS } from "@/app/(main)/course/working-with-ai-test/useYogaDetector";
import Countdown from "@/app/(main)/course/working-with-ai-test/Countdown";
import { Collapse, Image, Modal } from "antd";
import {
  HiOutlineQuestionMarkCircle,
  HiQuestionMarkCircle,
} from "react-icons/hi";
import Tutorial from "@/app/(main)/course/working-with-ai-test/Tutorial";
import { formatTime } from "@/app/(main)/course/working-with-ai-test/utils";
const YogaExercise = ({
  stop,
  skip,
  next,
