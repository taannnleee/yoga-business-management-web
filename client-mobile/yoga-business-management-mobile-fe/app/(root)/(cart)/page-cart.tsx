  ...
  const updateCartSubtract = async (cartItemId, productId, newQuantity) => {
    try {
      ...
      const response = await fetch(
        `${BASE_URL}/api/cart/subtract-from-cart-item`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            ...
            <View style={styles.cartItem} key={item.id}>
              <View style={styles.itemHeader}>
                ...
                <View style={styles.quantityControl}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleChangeQuantity(item.id, item.product.id, "decrease")
                    }
                  >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleChangeQuantity(item.id, item.product.id, "increase")
                    }
                  >
                    <Text style={styles.quantityButton}>+</Text>
                  </TouchableOpacity>
                ...
                <View style={styles.details}>
                  ...
                  <View style={styles.variantContainer}>
                    <Text style={styles.variantTitle}>
                      Màu sắc: {item.currentVariant.color.value}
                    </Text>
                    <Text style={styles.variantTitle}>
                      Size: {item.currentVariant.size.value}
                    </Text>
                  </View>
                </View>
                <TouchableOpacity
