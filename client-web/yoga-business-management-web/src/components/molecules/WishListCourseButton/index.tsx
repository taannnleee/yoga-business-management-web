...
import { HeartIcon } from "@heroicons/react/24/solid"; // Thêm HeartIcon
import { incrementTotalItems, setTotalItems } from "@/redux/cart/cartSlice"; // Redux actions
import { RootState } from "@/redux/store";

const WishListCourseButton = () => {
    ...
    return (
        <button
            ...
            onClick={() => router.replace("/course/wishlistcourse")}
        >
            {/* Thay ShoppingCartIcon thành HeartIcon */}
...
export default WishListCourseButton;
