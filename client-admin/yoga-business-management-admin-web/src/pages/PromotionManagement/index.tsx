...
import { Button, TextField, Box, Typography, FormControl, InputLabel, Select, MenuItem, SelectChangeEvent } from '@mui/material';
...
const PromotionManager: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8080/api/admin/create-promotion', {
                code: promotion.code,
