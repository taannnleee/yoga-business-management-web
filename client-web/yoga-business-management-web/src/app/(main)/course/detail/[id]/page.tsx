    ...
    <div className="w-screen">
      ...
      >
        ...
        <div className="relative text-center">
          <h3 className="text-orange-600 text-[36px] font-bold">
            {course.name}
          </h3>
          <p className="text-white text-[24px] my-6 font-thin">
            Discover the secrets of timeless youth
          </p>
          <button
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col items-center">
            <div
              ...
              style={{
                backgroundImage: `url("https://i.ytimg.com/vi_webp/xGMXPky1wUc/maxresdefault.webp")`,
              }}
              onClick={() =>
                window.open(
                  "https://www.youtube.com/watch?v=xGMXPky1wUc",
                  "_blank"
                )
              }
            >
            ...
            <div className="flex items-center mt-4">
              <div
                ...
                style={{
                  backgroundImage: `url("https://yt3.ggpht.com/ytc/AIdro_mCxSAtsHLQq8az5EiKyVQMziAocER_Z2xrPHqNuyIGYg=s88-c-k-c0x00ffffff-no-rj")`,
                }}
              ></div>
              <div className="ml-3">
                <a
                  href="https://www.youtube.com/channel/UCUnicaChannel"
                  target="_blank"
        ...
        <div className="flex justify-center items-center w-full">
          <div className="flex">
            ...
            >
              ...
              />
              <h3 className="text-lg cursor-pointer font-semibold my-[20px]">
                {course.teacher.fullName}
              </h3>
              <p className="text-gray-600 cursor-pointer">
                {course.teacher.experienceYears} năm kinh nghiệm
              </p>
            </div>
          </div>
        </div>
