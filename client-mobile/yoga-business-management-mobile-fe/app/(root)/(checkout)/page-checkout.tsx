...
// import { Radio, Button, Modal, Text, View, FlatList, ActivityIndicator } from "react-native";
...
//     return (
//         <View style={{ padding: 20, maxWidth: 1200, margin: "0 auto" }}>
...
//                         <Radio.Group onValueChange={handlePaymentChange} value={paymentMethod}>
//                             <Radio value="creditCard" label="Credit/Debit Card" />
//                             <Radio value="vnpay" label="VNPAY" />
//                             <Radio value="paypal" label="PayPal" />
//                             <Radio value="cash" label="Cash on Delivery (COD)" />
//                         </Radio.Group>
//                     </View>
//                 </View>
...
//                         </Text>
//                         <Button
//                             title={orderLoading ? "Loading..." : "Đặt hàng"}
...
//                         <Button title={orderLoading ? "Loading..." : "Place Order"} onPress={handleSubmit} />
//                     </View>
//                 </View>
//             </Modal>
//         </View>
