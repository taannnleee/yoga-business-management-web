  ...
  const handlePressRegister = async (values: any) => {
    try {
      ...
      if (response.status === 200) {
        ...
        toast.sendToast(
          "Success",
          response.data.message || "Sign up successfully"
        );
      ...
      setLoading(false);
      toast.sendToast("Error", error.message || "Register error", "error");
    ...
    <div className="w-full min-h-screen flex justify-center items-center bg-white py-12">
      ...
      >
        {/* <Box>
                    ...
                    >
                        Welcome to The Yoga, a marketplace that connects retailers and
